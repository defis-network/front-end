export default {
  ...
  tutorial: {
    ...
    title1: 'How to mint JIN',
    label1: 'Deposit EOS into smart contract and mint JIN.',
    ul1_1: 'Go to Bank page',
    ul1_2: 'Enter your EOS amount',
    ul1_3: 'Click Mint JIN button',
    ul1_4: 'Confirm the transaction',
    ul1_5: 'Wait until transaction is confirmed',

    title2: 'How to Redeem EOS',
    label2: 'Transfer JIN to smart contract and redeem EOS.',
    ul2_1: 'Go to Bank page',
    ul2_2: 'Select a record between all your minted records',
    ul2_3: 'Click Redeem button. Make sure you have enough balance of JIN',

    title3: 'How to swap',
    label3: 'Want to trade token, swap JIN to EOS or swap EOS to JIN ?',
